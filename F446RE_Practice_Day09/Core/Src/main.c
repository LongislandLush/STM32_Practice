...
volatile bool trigger_hardfault = false;
...
static void Trigger_UndefinedInstruction(void)
{
    /*
     * UDF：Undefined Instruction。
     * CPU 執行後會產生 UsageFault。
     */
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	 ...
	 if (trigger_hardfault)
	 {
		 trigger_hardfault = false;

		 Trigger_UndefinedInstruction();
	 }
